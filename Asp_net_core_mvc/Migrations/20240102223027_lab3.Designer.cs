...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Airline", b =>
                {
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Airport_", b =>
                {
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Flight", b =>
                {
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Passenger", b =>
                {
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Plane", b =>
                {
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Routes", b =>
                {
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Flight", b =>
                {
                    b.HasOne("Asp_net_core_mvc.Models.Plane", "Plane")
                        .WithMany("Flight")
                        .HasForeignKey("Plane_Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Asp_net_core_mvc.Models.Routes", "Route")
                        .WithMany("Flights")
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Plane", b =>
                {
                    b.HasOne("Asp_net_core_mvc.Models.Airline", "AirlineId")
                        .WithMany()
                        .HasForeignKey("AirlineIdAirline_id");

                    b.HasOne("Asp_net_core_mvc.Models.Airline", "Airline")
                        .WithMany("Plane")
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Routes", b =>
                {
                    ...
                    b.HasOne("Asp_net_core_mvc.Models.Airport_", "Airport_1")
                        .WithMany("Route1")
                        .HasForeignKey("Airport_ID_1")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Asp_net_core_mvc.Models.Airport_", "Airport_2")
                        .WithMany("Route2")
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Ticket", b =>
                {
                    b.HasOne("Asp_net_core_mvc.Models.Flight", "Flight")
                        .WithMany("Ticket")
                        .HasForeignKey("Flight_Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Asp_net_core_mvc.Models.Passenger", "Passenger")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("Asp_net_core_mvc.Models.Worker", b =>
                {
                    b.HasOne("Asp_net_core_mvc.Models.Airport_", "Airport")
                        .WithMany("Worker")
                        .HasForeignKey("AirportId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Asp_net_core_mvc.Models.Airport_", "Airports")
                        .WithMany()
